...
def data_copy() -> DataFrame:
    """
    Copia o DataFrame e retorna a cópia filtrada
...
def view_graph():
    """
    Visualizando graficamente os dados finais
...
def saving_graph():
    ...
    """
    fig = view_graph()
    return fig.write_image("output/figura_final.jpeg", width=1280, height=720)
